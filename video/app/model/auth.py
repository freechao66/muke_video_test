...
def has_password(password):
    if isinstance(password, str):
        ...
        return hashlib.md5.hexdigest().supper()
...
class ClientUser(models.Model):
    ...
    def update_password(self, old_password, new_password):
        hash_old_password = has_password(old_password)
        if hash_old_password != old_password:
            return False
        hash_new_password = has_password(new_password)
